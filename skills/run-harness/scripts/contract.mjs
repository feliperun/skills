...
export { HARNESS_VERSION, PROTOCOL_SCHEMA_VERSION } from "./drivers/index.mjs";

const CONTRACT_FIELDS = new Set([
  "schemaVersion", "harnessVersion", "id", "campaignId", "goal", "cwd", "sourceIdentity",
...
/** @typedef {{schemaVersion: number, harnessVersion: string, id: string, campaignId: string, goal: string, cwd: string, sourceIdentity: SourceIdentity, runtimes: Record<string, ValidatedRuntime>, runtimeDefaults: {worker: string, judge: string}, runtimeRules: ValidatedRuntimeRule[], nodes: ValidatedNode[], maxParallel: number, pollIntervalMs: number, stallTimeoutSec: number, timeoutSec: number, maxInputTokens?: number, warnings: string[]}} ValidatedContract */
...
export function validateContract(raw, contractPath) {
  ...
  return /** @type {ValidatedContract} */ ({
    ...
    harnessVersion: /** @type {string} */ (raw.harnessVersion),
    sourceIdentity,
    cwd,
    runtimes,
...
export function validateRunMetadata(value, options = {}) {
  ...
  rejectUnknown(value, new Set([
    "schemaVersion", "harnessVersion", "pid", "processStartToken", "startedAt", "sourceIdentity",
...
export function validateNodeSnapshot(value, expectedNode = null) {
  ...
  rejectUnknown(value, new Set([
    "schemaVersion", "harnessVersion", "id", "type", "sourceIdentity", "packetHash", "status", "phase",
...
export function validateEvent(value) {
  ...
  rejectUnknown(value, new Set([
    "schemaVersion", "harnessVersion", "at", "node", "from", "to", "phase", "attempt", "runtime",
...
function validateMetadata(value, label) {
  ...
  if (value.harnessVersion !== HARNESS_VERSION) {
    throw new TypeError(`${label}.harnessVersion must be ${HARNESS_VERSION}`);
  }
}
