 ...
 * @param {Map<string, import("./contract.mjs").NodeSnapshot>} states
...
export function planResumeRetry(contract, states, options = {}) {
  ...
  const attention = [];
  /** @type {(node: string, state: import("./contract.mjs").NodeSnapshot) => "recover"|"retry"|"rejudge"|"hold"} */
 ...
 *
 * @param {import("./contract.mjs").NodeSnapshot} state
