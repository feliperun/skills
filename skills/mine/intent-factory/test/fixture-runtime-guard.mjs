const REPORTED_DRIVERS = new Set(["codex", "claude", "agy", "glm"]);
 ...
 * agy, glm) but declares no `executable`, since env-preflight then falls back
 * to whatever binary of that name is first on PATH.
 *
 * @param {string} source
